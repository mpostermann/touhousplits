...
{
    /// <summary>
    /// Credit to baratgabor
    /// Copied from https://github.com/baratgabor/ProcessUtils32/blob/master/ProcessUtils32/ProcessUtils32.cs (as no release package could be found)
    /// 
